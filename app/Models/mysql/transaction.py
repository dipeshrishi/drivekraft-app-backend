...
class Transaction(db.Model):
    ...
    user = db.relationship('User', backref='transaction',foreign_keys=[userId])
    psychologist = db.relationship('Psychologist',backref='transaction',foreign_keys=[psychologistId])
